...
run_tool "Hawker" "python3 Hawker/main.py" "python3 Hawker/main.py $EMAIL"
run_tool "Hawker" "python3 Hawker/hawker.py" "python3 Hawker/main.py --email $EMAIL"
run_tool "h8mail" "h8mail" "h8mail -t $EMAIL"
run_tool "Eyes" "python3 Eyes/eyes.py" "python3 Eyes/eyes.py $EMAIL"
run_tool "Zehef" "python3 Zehef/zehef.py" "python3 Zehef/zehef.py $EMAIL"
run_tool "Email-Osint" "python3 Email-Osint/EmailOsint.py" "python3 Email-Osint/EmailOsint.py -e $EMAIL"
run_tool "Blackbird" "python3 blackbird/blackbird.py" "python3 blackbird/blackbird.py --email $EMAIL"
...
run_tool "Eyes" "python3 Eyes/eyes.py" "python3 Eyes/eyes.py email $EMAIL"
run_tool "Zehef" "python3 Zehef/zehef.py" "python3 Zehef/zehef.py email $EMAIL"
...
run_tool "Gumshoe" "python3 gumshoe/gumshoe.py" "python3 gumshoe/gumshoe.py -e $EMAIL"run_tool "Buster" "buster" "buster -e $EMAIL"
run_tool "MailOgleIt" "python3 mailogleit/mailogleit.py" "python3 mailogleit/mailogleit.py -e $EMAIL"
